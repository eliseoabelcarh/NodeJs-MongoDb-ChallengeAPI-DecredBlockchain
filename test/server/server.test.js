...
describe('TEST PARA SERVER Y USE CASES', async () => {
    ...
    describe('se envía datos para alta de usuario', async () => {
        it('devuelve status 200 con id de usuario agregado', async () => {
            const user = {
                name: 'JAMIE FALKLAND',
                lastname: 'ANDERSON',
                email: 'some@some.com',
            ...
            const { status, data } = await clienteRest.registrar(user)
            assert.deepStrictEqual(200, status)
        })
    })

    describe('se envía photIdFront para ser guardado en blockchain', async () => {
        it('devuelve status 200 con resultado 0 de guardado exitoso', async () => {
    ...
    describe('leemos los nombres y/o apellidos de la photoID y verificamos que sean iguales con la BD', async () => {
        it('devuelve status 200 si stampa en blockchain y valida status de dato verificado en BD', async () => {
            //randomSignature para no stampar en blockchain los mismos datos
    ...
    describe('se eligen los datos a compartir y se envía solicitud', async () => {
        it('devuelve status 200 y devuelve un id de vista para consultar los datos compartidos', async () => {
            //randomSignature para no stampar en blockchain los mismos datos
